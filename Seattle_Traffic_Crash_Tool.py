...
df = pd.read_csv(BASE_DIR / "final_df1.csv")
progress_bar.progress(25)
progress_text.text('Loading Data... 25%')
# seattle_gdf = gpd.read_file('tract20_king_county1.shp')
# seattle_gdf = gpd.read_file(BASE_DIR / "tract20_king_county1.shp")
seattle_gdf = gpd.read_file(BASE_DIR / "tract20_king_county1.shp", engine="pyogrio")
